            ...
            <div class="w-75 ml-4">
                ...
                <h2>Blogs</h2>
                    <div class="media border p-3 mb-2">
                        <img src="images/img_default.png" alt="John Doe" class="mr-3 mt-3 rounded-circle disp_pic" style="width:60px;" >
                        <div class="media-body">
                            <h4><span class="disp_title">A hard truth</span> <sub><span class="disp_name ml-1 mr-2"> -John Doe</span><i class="disp_date">Posted on February 19, 2016</i></sub></h4>
                            <p class="disp_con"></p>
